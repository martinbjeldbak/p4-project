...
Hej Hans og Nicolaj. Dette er vores besvarelse på den frie
projektrelateret opgave, hvor vi har valgt en delmængde af vores sprog
\junta{}, som er et funktionelt objektorienteret programmeringssprog.

Tankerne bag sproget er, at man skal kunne skrive brætspil i sproget,
der kan spilles ved hjælp af en simulator. Mange funktionelle principper
ses i sproget, da der ingen side effekter er og ingen program tilstand
findes.

Herunder defineres semantikken for følgende konstruktioner i
sproget: Let-in-udtryk, metodekald, member tilgang, liste-tilgang, lambda-udtryk,
set-konstruktionen og type (klasse) definitioner.
...
A type value consists of type names, variable lists, the member definitions,
