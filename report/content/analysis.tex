...
analysis is done in \secref{sec:syntacticanalysis} and which methods we can use
...
grammars have in \secref{sec:contextualconstraints}. Furthermore, we take a look
...
interpreter is. In \secref{sec:simulator} we investigate and describe how a game
