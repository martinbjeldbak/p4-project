...
\secref{sec:chessandkalah}. After the analysis of board games, we begin by analysing programming paradigms
...
and an interpreter is. In \secref{sec:simulator} we investigate and describe how a simulator can be use
