...
In \secref{sec:board-game-analysis} we begin by defining what a board game
actually is in.  What is the definition of it? Afterwards in
\secref{sec:chessandkalah} we analyse two board games, namely chess and kalah,
...
programming paradigms in \secref{sec:paradigms} and how the different paradigms
...
\secref{sec:contextualconstraints}. Furthermore, we take a look at code generation and interpretation of a given
...
and an interpreter is. In \secref{sec:simulator} we investigate and describe how a game simulator can
...
\input{content/analysis/syntacticanalysis/contextualconstraints}
