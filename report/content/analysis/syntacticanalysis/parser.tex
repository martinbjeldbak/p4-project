\subsubsection{LL-parsers and LR-parsers}
...
\fig[width=0.25\textwidth]{LL-parserandLR-parser}{The set of grammars accepted by different parsers. As illustrated LR(k)-parsers are supersets of LL(k)-parsers for different values of k}         
