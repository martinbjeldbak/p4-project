...
Before the syntax analysis can be performed, a scanner has to do a lexical analysis. The scanner takes an input stream of characters and outputs a stream of tokens. \todo{Det her afsnit skal skrive om!}
