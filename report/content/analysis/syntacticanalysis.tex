...
tokens can be combined (tokens will be described in \secref{sec:lexicalanalysis}).
...
described in this section in \secref{sec:context-freegrammars}. There exists two
...
parser derives from. In \secref{subsec:llparsersandlrparsers} we analyse how the
...
generate it, which is in \secref{subsec:constructingaparser}.
