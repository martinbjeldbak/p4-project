...
\fig[width=0.25\textwidth]{kalah}{The board game Kalah. There are six squares on each side belonging to each player, and there are two square in each end of the board, which represents the bases of the players.}
