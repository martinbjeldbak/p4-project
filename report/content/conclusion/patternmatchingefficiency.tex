...
\figref{fig:efficientpatterns}. The $8$ arrows show the moves a knight
...
\figref{fig:efficientpatterns}, namely the legal moves of a knight on
D3.

Compared to the current pattern matching in \productname{}, this
...
\figref{fig:connect4simulated}. These black squares are put there so the
