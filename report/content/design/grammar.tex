...
\galt{type\_def}
\grule{constant\_def}{\gter{define} \gcat function \gcat \gopt{varlist} \gcat \gter{=} \gcat \gcat expression}
\grule{type\_def}{\gter{type} \gcat type \gcat varlist \gcat \gopt{\gter{extends} \gcat type \gcat list} \opt{type\_body}}
\grule{type\_body}{\gter{\{} \gcat \grep{member\_def} \gcat \gter{\}}}
\grule{member\_def}{abstract\_def}
\galt{constant\_def}
\grule{abstract\_def}{\gter{define} \gcat \gter{abstract} \gcat function \gcat \gopt{varlist}}
...
\galt{operation}
\grule{operation}{minus\_op \gcat \gopt{operator \gcat expression}}
\grule{minus\_op}{\gopt{\gter{-}} \gcat call}
\grule{call}{element \gcat \gopt{list}
\grule{element}{atomic \gcat \grep{member_access}}
\grule{member\_access}{\gter{.} \gcat constant \gcat \gopt{list}}
...
The expression-expression and element-expression are the two main expressions which are repeatedly used to form different expressions such as assignments, conditional expressions, lambda expressions and lists.
...
\todo{how do we describe patterns?}

\todo{is a summary needed here?}
