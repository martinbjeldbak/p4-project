...
All named functions (\texttt{define}-ed functions, not lambda expressions) exist in
the global scope. Also, it is not necessary to define a function before use, so something
