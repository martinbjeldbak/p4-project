...
\begin{dlist}
  \item \texttt{\constant{typeOf}[\variable{value} : \opstar] : \type{Type}}\\
    Return the type of any value.
  \item \texttt{\constant{union}[\variable{list} : \type{List}, ... \variable{lists} : \type{List}] : \type{Type}}\\
    Return the union of a number of lists.
  \item \texttt{\constant{true} : \type{Boolean}}\\
    The boolean true value.
  \item \texttt{\constant{false} : \type{Boolean}}\\
