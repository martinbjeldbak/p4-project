...
\tab[\textwidth]{operatorPrecedence}{2}{caption}
         {Operator precedence}
  {Level}{Operator & Description}{
    ...
    \tabrow{7}{\texttt{== !=} & Equality operators}
    \tabrow{8}{\texttt{and or} & Logical $and$ and $or$}
    \tabrow{9}{\texttt{not} & Logical $not$}
    \tabrow{10}{\texttt{if let \#} & if expressions, let expressions, and lambda expressions}
}
...
\begin{dlist}
  ...
  \item \operator[String]{+}{Integer}{String} \\
   ...
   \operator[String]{+}{Identifier}{String} \\
   ...
   \operator[Identifier]{+}{String}{String} \\
