...
\textbf{Definition} (Object values) \hspace{0.5cm} The set of object values is
defined as follows:
...
is yet another recursively defined definition.  \todo{And why is that? :)}
...
of the members og the syntactic categories. 

Not all of the constiuents of the formulation rules are syntactic categories. We
for instance see different parentheses, forwardslashes, different operators, and
