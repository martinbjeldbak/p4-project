...
\tab[\textwidth]{operatorPrecedence}{3}{The precedence of operators in \productname{}.}
         {Operator precedence}
  {Level}{Operator & Description & Associated rule}{
    \tabrow{1}{\texttt{f[]} & Function/constructor invocation and list access & $call\_sequence$ }
