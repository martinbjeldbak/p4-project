...
%The purpose of a requirements specification is to make sure that the final product is able to do what is was intended to do and meets the specified requirements. 
