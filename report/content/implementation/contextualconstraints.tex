...
Notice how the four code samples in \lstref{lst:ose} all result in the same
...
\fig[height=5em]{scope1}{Four different expressions that all result in the scope action
depicted.}
...
\lstref{lst:scope2}. If only a single symbol table was used, an incorrect double
