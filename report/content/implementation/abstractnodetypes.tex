...
\subsection{Difference between an AST and a parse tree}
...
\subsection{The ANT for program}
...
production for this rule was presented in \secref{sec:grammar}.
...
\subsection{ANT for operations with precedence and negation}
...
grammar for this expression was presented in \secref{sec:grammar}.
