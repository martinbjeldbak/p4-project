...
Our scanner consists of classes: \classref{Scanner} and
...
\tab[14cm]{scanner}{2}{The different groupings of characters, the method responsible for handling them and the possible returned token types}
                 		 {Action and output												}
