...
The parser was very simple to implement, because it is structured exactly as the
grammar which is defined in \chapref{chap:design}. For instance if the grammar
